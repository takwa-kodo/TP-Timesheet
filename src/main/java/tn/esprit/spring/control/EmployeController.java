...
import tn.esprit.spring.service.EmployeServiceImpl;
...
public class EmployeController {
	...
	@ResponseBody
	public void affecterContratAEmploye(@PathVariable("Employer-id") String employeId,
			@PathVariable("Contrat-id") String contratId) {
	...
	@PutMapping("/Affecter-Employe-Departement/{Departement-id}/{Employer-id}")
	@ResponseBody
	public void affecterEmployeADepartement(@PathVariable("Employer-id") String employeId,
			@PathVariable("Departement-id") String depId) {
		employeService.affecterEmployeADepartement(Integer.valueOf(employeId), Integer.valueOf(depId));
	}
}
